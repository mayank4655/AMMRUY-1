  ...
  return (
    <>
      <main className="md:flex md:justify-between md:items-center md:gap-24 max-h-full">
        <div
          className={`signup text-center w-[100vw] mx-auto duration-500 ${
            clicked ? "md:translate-x-[70%]" : "md:translate-x-0"
          }`}
        >
          <div className="content md:ml-72 md:w-[60vmin] mx-auto w-[80%]">
            <div className="header text-center">
              {!login ? (
                <h1 className="font-bold text-4xl">Create Free Account</h1>
              ) : (
            ...
            <div className="already md:hidden flex gap-1">
              ...
              <span onClick={loginHandler} className="text-blue-600">
                {!login ? "Login" : "Signup"}
              </span>
            </div>
          </div>
        ...
        <div
          className={`login md:block hidden login-bg text-center h-screen duration-500 ${
            clicked
              ? "md:transform md:translate-x-[-150%]"
