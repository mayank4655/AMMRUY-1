...
const Rating = () => {
  ...
  const fetchRatings = async () => {
    try {
      const response = await axios.get('https://sharp-backend.onrender.com/ratings');
  ...
  const submitRating = async () => {
    try {
      ...
      await axios.post('https://sharp-backend.onrender.com/ratings', { service: selectedService, rating: newRating },{
        headers: {
